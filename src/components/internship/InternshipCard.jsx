...
const InternshipCard = ({ internship, showApply = false, index = 0 }) => {
  ...
  return (
    <motion.div 
      ...
      className="bg-[#111111] rounded-3xl border border-[#1f1f1f] p-8 flex flex-col hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] transition-all duration-500 group cursor-pointer h-full relative overflow-hidden"
    >
